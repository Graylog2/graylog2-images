...
pipeline
{
   ...
   parameters
   {
       ...
       gitParameter branchFilter: 'origin/(.*)', defaultValue: 'jenkins', name: 'BRANCH', type: 'PT_BRANCH', sortMode: 'DESCENDING_SMART', description: 'The branch name that should be used for the build.'
